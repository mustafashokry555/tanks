...
@section('content')
    ...
    <section id="portfolio" class="portfolio section">
        ...
        <!-- Section Title -->
        <div class="container section-title" data-aos="fade-up">
            <h2>{{ __('web.Portfolio') }}</h2>
            <p>{{ __('web.portfolio_text') }}</p>
        </div><!-- End Section Title -->
            ...
            <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
                ...
                <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                        <img src="{{ asset('assets/web/img/masonry-portfolio/1.jpg') }}"
                            class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>App 1</h4>
                            <p>Lorem ipsum, dolor sit</p>
                            <a href="{{ asset('assets/web/img/masonry-portfolio/1.jpg') }}"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
                        <img src="{{ asset('assets/web/img/masonry-portfolio/2.jpg') }}"
                            class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>Product 1</h4>
                            <p>Lorem ipsum, dolor sit</p>
                            <a href="{{ asset('assets/web/img/masonry-portfolio/2.jpg') }}"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
                        <img src="{{ asset('assets/web/img/masonry-portfolio/3.jpg') }}"
                            class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>Branding 1</h4>
                            <p>Lorem ipsum, dolor sit</p>
                            <a href="{{ asset('assets/web/img/masonry-portfolio/3.jpg') }}"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                        <img src="{{ asset('assets/web/img/masonry-portfolio/4.jpg') }}"
                            class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>App 2</h4>
                            <p>Lorem ipsum, dolor sit</p>
                            <a href="{{ asset('assets/web/img/masonry-portfolio/4.jpg') }}"
    ...
    <section id="team" class="team section">
        ...
        <!-- Section Title -->
        <div class="container section-title" data-aos="fade-up">
            <h2>{{ __('web.team_title') }}</h2>
            <p>{{ __('web.team_text') }}</p>
        </div>
        <!-- End Section Title -->
    ...
    <section id="contact" class="contact section">
        ...
        <!-- Section Title -->
        <div class="container section-title" data-aos="fade-up">
            <h2>{{ __('web.contact_title') }}</h2>
            <p>{{ __('web.contact_text') }}</p>
        </div>
        <!-- End Section Title -->
